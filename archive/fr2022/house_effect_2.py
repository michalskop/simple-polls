...
csv_file = "https://docs.google.com/spreadsheets/d/e/2PACX-1vTgg1x2P_SS-52MmixvFPtK1JdiEQOeWcvut1Xk65JJFq6KGs0sUxcNADY8LKgc_DK3PEd07S2piyri/pub?gid=1157811857&single=true&output=csv"
path = 'fr2022/'

polls_min = 4

selected = ['Macron', 'Le Pen']
...
wsw = sh.worksheet('house effect Le Pen / Macron')
...
# write to file
he.to_csv(path + 'house_effect_LePen_Macron.csv', index=False)
