...
wsw.update(range_name='B1', values=[ranks_statistics_aging.transpose().columns.values.tolist()] + ranks_statistics_aging.transpose().values.tolist())

wsw = sh.worksheet('pořadí_aktuální_aging_cov')
wsw.update(range_name='B1', values=[ranks_statistics_aging_cov.transpose().columns.values.tolist()] + ranks_statistics_aging_cov.transpose().values.tolist())
...
for item in arr:
  arr2.append([item])
wsw.update(range_name='A2', values=arr2)
wsw.update(range_name='B1', values=[interval_statistics_aging.columns.values.tolist()] + interval_statistics_aging.values.tolist())

wsw = sh.worksheet('pravděpodobnosti_aktuální_aging_cov')
wsw.update(range_name='A2', values=arr2)
wsw.update(range_name='B1', values=[interval_statistics_aging_cov.columns.values.tolist()] + interval_statistics_aging_cov.values.tolist())
...
for item in duels_aging.columns:
  arrd.append([item])
wsw.update(range_name='A3', values=arrd)
wsw.update(range_name='B2', values=[duels_aging.columns.values.tolist()] + duels_aging.values.tolist())
...
for item in duels_aging_cov.columns:
  arrd.append([item])
wsw.update(range_name='A3', values=arrd)
wsw.update(range_name='B2', values=[duels_aging_cov.columns.values.tolist()] + duels_aging_cov.values.tolist())

wsw = sh.worksheet('top_2')
wsw.update(range_name='A3', values=arrd)
wsw.update(range_name='B2', values=[top2_statistics.columns.values.tolist()] + top2_statistics.values.tolist())

wsw = sh.worksheet('top_2_cov')
wsw.update(range_name='A3', values=arrd)
wsw.update(range_name='B2', values=[top2_statistics_cov.columns.values.tolist()] + top2_statistics_cov.values.tolist())
...
wsw.update(range_name='A2', values=number_in_aging_cov.values.tolist())
